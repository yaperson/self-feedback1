...
<body>
    ...
    <div class=\"bloc_dashboard\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["notes"]) {
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["notes"], "note_Id", [], "any", false, false, false, 55), "html", null, true);
            echo " </th> <th>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["notes"], "note_Valeur_Repas", [], "any", false, false, false, 55), "html", null, true);
            echo "<img src=\"/images/star.svg\" class=\"table_star\"></th> <th>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["notes"], "note_Valeur_Environnement", [], "any", false, false, false, 55), "html", null, true);
            echo "<img src=\"/images/star.svg\" class=\"table_star\"></th> <th>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["notes"], "note_Commentaire", [], "any", false, false, false, 55), "html", null, true);
            echo "</th> <th>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["notes"], "classe_Id", [], "any", false, false, false, 55), "html", null, true);
            echo "</th></tr>
            ";
        }
    ...
    {
        return array (  123 => 57,  106 => 55,  102 => 54,  87 => 42,  58 => 15,  52 => 13,  50 => 12,  37 => 1,);
    }
