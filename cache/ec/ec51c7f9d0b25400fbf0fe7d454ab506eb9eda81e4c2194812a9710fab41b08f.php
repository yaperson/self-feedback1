...
<body>
    ...
    <h1>FeedBack - ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["classes"]) {
            // line 49
            echo "               <tr><th>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["classes"], "classe_Id", [], "any", false, false, false, 49), "html", null, true);
            echo "</th> <th>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["classes"], "classe_libelle", [], "any", false, false, false, 49), "html", null, true);
            echo "</th></tr>
            ";
        }
